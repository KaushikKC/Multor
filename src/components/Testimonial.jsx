...
function Testimonial() {
  return (
    <div>
        <section class="bg-white md:mt-[150px]">
  <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
    <h2 class="text-center text-2xl font-bold tracking-tight text-[#92e5e6] sm:text-3xl">
      ...
      <blockquote class="rounded-lg bg-gray-100 p-8">
        <div class="flex items-center gap-4">
          ...
          <div>
            ...
            <p class="mt-1 text-lg font-medium text-gray-700">Real Name</p>
          </div>
        </div>
